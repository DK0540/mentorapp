...
const UserCard = ({filterName, filterCriteria}) => {
  ...
  //filter
  const filteredData = userData.filter(personal => {
    const nameMatch = personal.name
      .toLowerCase()
    ...
    return nameMatch && personal.availability === filterCriteria;
  });

  return (
    <ScrollView contentContainerStyle={styles.cardContainer}>
      {filteredData.map(Personal => (
