...
const LoginScreen = ({}) => {
  ...
  return (
    <ImageBackground
      ...
      <ImageBackground
        source={require('./Assets/log&sign.png')}
          ...
          <View style={styles.passwordContainer1}>
            ...
            <TouchableOpacity
              ...
              <Image
                source={
                  showPassword
                    ? require('./Assets/open-eye.png') // Eye icon when the password is visible
                    : require('./Assets/close-eye.png') // Eye icon when the password is hidden
                }
                style={[
