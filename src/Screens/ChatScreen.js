  ...
  return (
    <View style={styles.header}>
      ...
      <TouchableOpacity style={styles.profileContainer}>
        <Image
          source={require('./Home/Assetb/2.jpg')}
      ...
      <TouchableOpacity
        ...
        <Image
          source={require('./Home/Assetb/more_vert_FILL0_wght400_GRAD0_opsz48.png')}
      ...
      <Modal visible={buyPopupVisible} transparent={true} animationType="slide">
        <View style={styles.buyPopupContainer}>
          <View style={styles.buyPopupContent}>
            <Image
              source={require('./Home/Assetb/send.png')}
            ...
            <TouchableOpacity
              ...
              <Image
                source={require('./Home/Assetb/close.png')}
  ...
  const PinnedContent = ({pinnedMessages}) => {
    ...
    return (
      <View style={styles.pinnedContentContainer}>
        <Image
          source={require('./Home/Assetb/pin.png')}
      ...
      <View style={styles.backgroundColor}>
        <View style={styles.inputContainer}>
          ...
          <TouchableOpacity
            ...
            <Image
              source={require('./Home/Assetb/attachment_FILL0_wght400_GRAD0_opsz48.png')}
